...
* QFLCA project's code without the documentation (website) and demo video files can be found under the $${\color{teal} </code/root/lab/sim/QFLCC classifiers>}$$ directory in <code style="color : red"> </code/root/lab/sim/QFLCC classifiers/docs> </code> and </code/root/lab/sim/QFLCC classifiers/site> folders at https://doi.org/10.24433/CO.9905505.v2. 
