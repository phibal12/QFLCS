...
The project repositories are available at [https://data.mendeley.com/datasets/gf2s8jkdjf/3](https://data.mendeley.com/datasets/gf2s8jkdjf/3){:target="_blank"} and https://doi.org/10.24433/CO.9905505.v2, which include the code, project website documentation and demo video files.

<kbd> ![1D QDF circuit](1D-qdf-circuit.gif){:target="_blank"} </kbd> 
...
<kbd> ![QDF_Demo Line](QDF_demo_line.gif){:target="_blank"} </kbd>
...
<kbd> ![k-trans-QDF-P-measure-IN](k-trans-QDF-P-measure-IN.png){:target="_blank"} </kbd>
...
<kbd> ![QDF_Circuit_and Dataset Analysis](QDF_circuit_screenshot.jpg){:target="_blank"} </kbd>
...
<kbd> ![QDF Game Scores Screenshot](QDF_game_screenshot.jpg){:target="_blank"} </kbd>
...
<kbd> ![QFLCS Graphical Abstract (SIMPAC journal)](./root/SIMPAC_GAbstract.jpg){:target="_blank"} </kbd>
...
<kbd> ![QFLCA Graphical Abstract (DIB journal)](./root/DIB_GAbstract.png){:target="_blank"} </kbd>
